...
<div class="col_w420 float_l">
        ...
        <br />
                ...
                <tr>
                <td class="style1">
                    <asp:Label ID="Label3" runat="server" Text="E-Posta :" ForeColor="White"></asp:Label>
                    </td>
                <td class="style2">
                    <asp:TextBox ID="TextBox4" runat="server" BackColor="#32327F" ForeColor="White"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                <td colspan="2">
                ...
                <td class="style2">
                    ...
                    <asp:Button runat="server" ID="Button1" Text="Gönder" BackColor="#6A69A2" 
